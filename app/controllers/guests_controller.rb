class GuestsController < ApplicationController
  ...
  def index
    ...
    if params[:search]
			@guests = Guest.search(params[:search]).order("created_at DESC")
			else
  ...
  def update
    respond_to do |format|
      if @guest.update(guest_params)
        format.html { redirect_to beds_url, notice: 'Guest was successfully updated.' }
  ...
  private
    ...
    def guest_params
      params.require(:guest).permit(:name, :locker, :price, :deposit, :nationality, :note, :passport_number, :payment_method)
    end
end
